      ...
      >
        <div className="relative flex min-h-screen flex-col">
          ...
          <header className="sticky top-0 z-50 w-full border-b border-slate-800/50 bg-slate-950/70 backdrop-blur-xl">
            <div className="container flex h-16 items-center justify-between px-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <Link href="/wallet" className="h-9 rounded-full bg-cyan-600 px-4 text-sm font-medium text-white hover:bg-cyan-500 transition-all shadow-lg shadow-cyan-900/20 active:scale-95 flex items-center">
                  Deposit
                </Link>
              </div>
            </div>
          ...
          <nav className="fixed bottom-0 left-0 right-0 z-50 flex md:hidden border-t border-slate-800 bg-slate-950/95 backdrop-blur-xl pb-safe">
            ...
            <Link href="/sports" className="flex flex-1 flex-col items-center gap-1 py-3 text-slate-400 hover:text-cyan-400 transition-colors">
            ...
            <Link href="/wallet" className="flex flex-1 flex-col items-center gap-1 py-3 text-cyan-400">
